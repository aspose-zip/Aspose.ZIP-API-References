...
description: Yeni bir örneğini başlatırWimArchiveaspose.zip.wim/wimarchive sınıf ve oluşturur girdiler listesi arşivden çıkarılabilir.
type: docs
weight: 10
...
Yeni bir örneğini başlatır[`WimArchive`](../../wimarchive) sınıf ve oluşturur girdiler listesi arşivden çıkarılabilir.
...
Bu kurucu herhangi bir girdiyi açmaz. Görmek[`Open`](../../wimfileentry/open) paketi açma yöntemi.
