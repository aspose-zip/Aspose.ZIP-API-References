...
---
## SharArchive.Save method (1 of 2)
...
## SharArchive.Save method (2 of 2)
...
| ArgumentException | *output* is not writable. - or - *output* is the same stream we extract from. - OR - It is impossible to save archive in *sharFormat* due to format restrictions. |
