...
| [ZstandardArchive](zstandardarchive/#constructor_1)(Stream) | Initializes a new instance of the `ZstandardArchive` class prepared for decompressing. |
| [ZstandardArchive](zstandardarchive/#constructor_2)(string, bool) | Initializes a new instance of the `ZstandardArchive` class. |
...
| [Save](../../aspose.zip.zstandard/zstandardarchive/save/#save)(FileInfo) | Saves archive to destination file provided. |
| [Save](../../aspose.zip.zstandard/zstandardarchive/save/#save_1)(Stream) | Saves archive to the stream provided. |
| [Save](../../aspose.zip.zstandard/zstandardarchive/save/#save_2)(string) | Saves archive to destination file provided. |
