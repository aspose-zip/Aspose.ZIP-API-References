...
| Name | Description |
| --- | --- |
| [Extract](../../aspose.zip.xar/xarfileentry/extract)(Stream) | Extracts the entry to the stream provided. |
| [Extract](../../aspose.zip.xar/xarfileentry/extract)(string) | Extracts the entry to the filesystem by the path provided. |
