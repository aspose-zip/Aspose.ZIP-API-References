...
description: AlzEntry method. Extracts the entry to the filesystem by the path provided
type: docs
weight: 60
url: /net/aspose.zip.alz/alzentry/extract/
---
...
Extract an entry of ALZ archive with password.
