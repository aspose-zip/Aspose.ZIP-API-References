---
title: Class AlzEntry
second_title: Aspose.ZIP for .NET API Reference
description: Aspose.Zip.Alz.AlzEntry class. Represents a file entry in an ALZ archive with all its metadata
type: docs
weight: 30
url: /net/aspose.zip.alz/alzentry/
---
## AlzEntry class
...
| Name | Description |
| --- | --- |
| [Extract](../../aspose.zip.alz/alzentry/extract/#extract_1)(Stream, string) | Extracts the entry to the stream provided. |
| [Extract](../../aspose.zip.alz/alzentry/extract/#extract)(string, string) | Extracts the entry to the filesystem by the path provided. |
