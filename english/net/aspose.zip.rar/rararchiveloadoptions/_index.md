...
| Name | Description |
| --- | --- |
| [RarArchiveLoadOptions](rararchiveloadoptions/)() | Initializes a new instance of the `RarArchiveLoadOptions` class. |
...
| [DictionaryStorageMode](../../aspose.zip.rar/rararchiveloadoptions/dictionarystoragemode/) { get; set; } | Gets or sets how the RAR decompression dictionary is stored. |
| [TemporaryDirectory](../../aspose.zip.rar/rararchiveloadoptions/temporarydirectory/) { get; set; } | Gets or sets the directory used for temporary dictionary files. |
