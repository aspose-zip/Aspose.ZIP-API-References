...
| Name | Description |
| --- | --- |
| [Extract](../../aspose.zip.wim/wimfileentry/extract)(Stream) | Extracts the entry to the stream provided. |
| [Extract](../../aspose.zip.wim/wimfileentry/extract)(string) | Extracts the entry to the filesystem by the path provided. |
