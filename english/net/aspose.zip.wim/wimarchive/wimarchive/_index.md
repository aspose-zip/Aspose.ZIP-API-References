...
---
## WimArchive constructor (1 of 2)

Initializes a new instance of the [`WimArchive`](../../wimarchive) class and composes entries list can be extracted from the archive.
