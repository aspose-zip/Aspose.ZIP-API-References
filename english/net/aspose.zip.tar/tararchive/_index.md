...
| static [FromZstandard](../../aspose.zip.tar/tararchive/fromzstandard)(Stream) | Extracts supplied Zstandard archive and composes [`TarArchive`](../tararchive) from extracted data. |
| static [FromZstandard](../../aspose.zip.tar/tararchive/fromzstandard)(string) | Extracts supplied Zstandard archive and composes [`TarArchive`](../tararchive) from extracted data. |
...
| [SaveZstandard](../../aspose.zip.tar/tararchive/savezstandard)(Stream, TarFormat?) | Saves archive to the stream with Zstandard compression. |
| [SaveZstandard](../../aspose.zip.tar/tararchive/savezstandard)(string, TarFormat?) | Saves archive to the file by path with Zstandard compression. |
