...
Initializes a new instance of the [`PPMdCompressionSettings`](../../ppmdcompressionsettings) class.
...
Initializes a new instance of the [`PPMdCompressionSettings`](../../ppmdcompressionsettings) class with default model order and sub-allocator size.
