...
| Name | Description |
| --- | --- |
| [DictionarySize](dictionarysize) { get; } | Dictionary (history buffer) size indicates how many bytes of the recently processed uncompressed data is kept in memory. |
