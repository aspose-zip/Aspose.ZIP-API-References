...
description: Пространство именBzip2содержит классы которые представляют объекты связанные с архивом bzip2.
type: docs
weight: 20
url: /ru/net/aspose.zip.bzip2/
---
Пространство именBzip2содержит классы, которые представляют объекты, связанные с архивом bzip2.
