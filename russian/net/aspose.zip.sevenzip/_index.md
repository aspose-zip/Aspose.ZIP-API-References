...
description: Пространство именSevenZipсодержит классы которые представляют объекты связанные с архивом 7z.
type: docs
weight: 100
url: /ru/net/aspose.zip.sevenzip/
---
Пространство именSevenZipсодержит классы, которые представляют объекты, связанные с архивом 7z.
