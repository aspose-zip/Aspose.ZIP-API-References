...
| Имя | Описание |
| --- | --- |
| [CpioArchive](cpioarchive#constructor)() | Инициализирует новый экземпляр[`CpioArchive`](../cpioarchive) класс. |
| [CpioArchive](cpioarchive#constructor_1)(Stream) | Инициализирует новый экземпляр[`CpioArchive`](../cpioarchive) список записей классов и композиций можно извлечь из архива. |
| [CpioArchive](cpioarchive#constructor_2)(string) | Инициализирует новый экземпляр[`CpioArchive`](../cpioarchive) список записей классов и композиций можно извлечь из архива. |
