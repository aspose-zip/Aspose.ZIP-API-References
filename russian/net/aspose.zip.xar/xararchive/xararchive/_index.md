...
description: Инициализирует новый экземплярXarArchiveaspose.zip.xar/xararchive список записей классов и композиций можно извлечь из архива.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`XarArchive`](../../xararchive) список записей классов и композиций можно извлечь из архива.
