...
description: Получает или задает оценку памяти в мегабайтах доступную для размещения сжатых записей без свопинга на диск. Это значение имеет смысл только еслиParallelCompressInMemoryaspose.zip.saving/paralleloptions/parallelcompressinmemory настройка находится вAuto режим.
type: docs
weight: 20
