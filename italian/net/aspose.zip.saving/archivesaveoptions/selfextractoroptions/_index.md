...
description: Ottiene o imposta le impostazioni per larchivio autoestratto.
type: docs
weight: 60
...
Assegnalo se devi comporre un programma eseguibile per estrarre un archivio senza alcun software installato sul computer di destinazione.
