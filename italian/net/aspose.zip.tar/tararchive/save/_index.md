...
| --- | --- |
| ArgumentException | *output* non è scrivibile. - o -*output* è lo stesso flusso da cui estraiamo. - OPPURE - Impossibile salvare l'archivio in*format* a causa di restrizioni di formato. |
...
| UnauthorizedAccessException | *destinationFileName* ha specificato un file di sola lettura e l'accesso non è di lettura.-oppure- il percorso ha specificato una directory.-oppure- Il chiamante non dispone dell'autorizzazione richiesta. |
