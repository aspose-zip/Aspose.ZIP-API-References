...
description: Salva larchivio nel file di destinazione fornito.
type: docs
weight: 80
...
| ArgumentException | *output* non è scrivibile. - o -*output* è lo stesso flusso da cui estraiamo. - OPPURE - Impossibile salvare l'archivio in*cpioFormat* a causa di restrizioni di formato. |
