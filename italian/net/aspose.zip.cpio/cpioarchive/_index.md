...
description: Questa classe rappresenta il file di archivio cpio.
type: docs
weight: 120
...
| Nome | Descrizione |
| --- | --- |
| [CpioArchive](cpioarchive#constructor)() | Inizializza una nuova istanza di[`CpioArchive`](../cpioarchive) classe. |
| [CpioArchive](cpioarchive#constructor_1)(Stream) | Inizializza una nuova istanza di[`CpioArchive`](../cpioarchive) classe e compone l'elenco delle voci può essere estratto dall'archivio. |
| [CpioArchive](cpioarchive#constructor_2)(string) | Inizializza una nuova istanza di[`CpioArchive`](../cpioarchive) classe e compone l'elenco delle voci può essere estratto dall'archivio. |
...
| [SaveXzCompressed](../../aspose.zip.cpio/cpioarchive/savexzcompressed#savexzcompressed_1)(string, CpioFormat, XzArchiveSettings) | Salva l'archivio nel percorso per percorso con compressione xz. |
