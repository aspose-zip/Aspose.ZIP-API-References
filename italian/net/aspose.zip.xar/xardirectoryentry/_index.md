...
description: Rappresenta la voce della directory allinterno dellarchivio xar.
type: docs
weight: 690
...
| Nome | Descrizione |
| --- | --- |
| [AllEntries](../../aspose.zip.xar/xardirectoryentry/allentries) { get; } | Ottiene tutte le voci di[`XarEntry`](../xarentry) digitare che costituisce la directory in modo ricorsivo. |
| [CreationTime](../../aspose.zip.xar/xarentry/creationtime) { get; } | Ottiene l'ora di creazione del file o della directory. |
| [Directories](../../aspose.zip.xar/xardirectoryentry/directories) { get; } | Ottiene le voci di[`XarDirectoryEntry`](../xardirectoryentry) tipo che costituisce la directory. |
