...
description: Questa classe rappresenta il file di archivio bzip2. Usalo per comporre o estrarre archivi bzip2.
type: docs
weight: 60
...
| Nome | Descrizione |
| --- | --- |
| [Bzip2Archive](bzip2archive#constructor)() | Inizializza una nuova istanza di[`Bzip2Archive`](../bzip2archive) classe preparata per la compressione. |
| [Bzip2Archive](bzip2archive#constructor_1)(Stream) | Inizializza una nuova istanza di[`Bzip2Archive`](../bzip2archive) classe preparata per la decompressione. |
| [Bzip2Archive](bzip2archive#constructor_2)(string) | Inizializza una nuova istanza di[`Bzip2Archive`](../bzip2archive) classe preparata per la decompressione. |
...
| [Open](../../aspose.zip.bzip2/bzip2archive/open)() | Apre l'archivio per l'estrazione e fornisce uno stream con il contenuto dell'archivio. |
| [Save](../../aspose.zip.bzip2/bzip2archive/save#save_1)(string) | Salva l'archivio nel file di destinazione fornito. |
