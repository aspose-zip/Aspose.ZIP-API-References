...
description: Initierar en ny instans avBzip2Archiveaspose.zip.bzip2/bzip2archive klass förberedd för komprimering.
type: docs
weight: 10
...
Initierar en ny instans av[`Bzip2Archive`](../../bzip2archive) klass förberedd för komprimering.
...
Initierar en ny instans av[`Bzip2Archive`](../../bzip2archive) klass förberedd för dekomprimering.
