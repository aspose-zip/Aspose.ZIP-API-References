...
description: Initierar en ny instans avCpioArchiveaspose.zip.cpio/cpioarchive class.
type: docs
weight: 10
...
Initierar en ny instans av[`CpioArchive`](../../cpioarchive) class.
...
Initierar en ny instans av[`CpioArchive`](../../cpioarchive) klass och komponerar poster lista kan extraheras från arkivet.
