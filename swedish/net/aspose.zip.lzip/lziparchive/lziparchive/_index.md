...
description: Initierar en ny instans avLzipArchiveaspose.zip.lzip/lziparchive .
type: docs
weight: 10
...
Initierar en ny instans av[`LzipArchive`](../../lziparchive) .
...
Initierar en ny instans av[`LzipArchive`](../../lziparchive) klass förberedd för dekomprimering.
