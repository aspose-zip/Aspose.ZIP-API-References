...
description: Den här klassen representerar Lziparkivfil. Använd den för att komponera eller extrahera Lziparkiv.
type: docs
weight: 200
...
| namn | Beskrivning |
| --- | --- |
| [LzipArchive](lziparchive#constructor)(LzipArchiveSettings) | Initierar en ny instans av[`LzipArchive`](../lziparchive) . |
| [LzipArchive](lziparchive#constructor_1)(Stream) | Initierar en ny instans av[`LzipArchive`](../lziparchive) klass förberedd för dekomprimering. |
| [LzipArchive](lziparchive#constructor_2)(string) | Initierar en ny instans av[`LzipArchive`](../lziparchive) klass förberedd för dekomprimering. |
