...
description: Initierar en ny instans avSevenZipArchiveaspose.zip.sevenzip/sevenziparchiveklass med valfria inställningar för dess poster.
type: docs
weight: 10
...
Initierar en ny instans av[`SevenZipArchive`](../../sevenziparchive)klass med valfria inställningar för dess poster.
...
Initierar en ny instans av[`SevenZipArchive`](../../sevenziparchive) klass och komponerar poster lista kan extraheras från arkivet.
