...
description: Initierar en ny instans avTarArchiveaspose.zip.tar/tararchive class.
type: docs
weight: 10
...
Initierar en ny instans av[`TarArchive`](../../tararchive) class.
...
Initierar en ny instans av[`TarArchive`](../../tararchive) klass och komponerar poster lista kan extraheras från arkivet.
