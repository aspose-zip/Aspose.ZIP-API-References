...
description: Den här klassen representerar gziparkivfilen. Använd den för att komponera eller extrahera gziparkiv.
type: docs
weight: 160
...
| namn | Beskrivning |
| --- | --- |
| [GzipArchive](gziparchive#constructor)() | Initierar en ny instans av[`GzipArchive`](../gziparchive) klass förberedd för komprimering. |
| [GzipArchive](gziparchive#constructor_1)(Stream, bool) | Initierar en ny instans av[`GzipArchive`](../gziparchive) klass förberedd för dekomprimering. |
| [GzipArchive](gziparchive#constructor_2)(string, bool) | Initierar en ny instans av[`GzipArchive`](../gziparchive) class. |
