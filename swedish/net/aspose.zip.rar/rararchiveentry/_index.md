...
Kasta en[`RarArchiveEntry`](../rararchiveentry) instans till[`RarArchiveEntryEncrypted`](../rararchiveentryencrypted) för att avgöra om posten är krypterad eller inte.
