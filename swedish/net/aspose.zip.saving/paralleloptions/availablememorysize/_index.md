...
description: Hämtar eller ställer in minnesuppskattning i megabyte tillgängligt för att ta emot komprimerade poster utan att byta till disk. Detta värde är bara vettigt omParallelCompressInMemoryaspose.zip.saving/paralleloptions/parallelcompressinmemory inställningen är inneAuto läge.
type: docs
weight: 20
