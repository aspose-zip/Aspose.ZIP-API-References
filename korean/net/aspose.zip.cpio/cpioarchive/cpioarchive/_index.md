...
description: CpioArchive 건설자. 의 새 인스턴스를 초기화합니다.CpioArchive 클래스.
type: docs
weight: 10
url: /ko/net/aspose.zip.cpio/cpioarchive/cpioarchive/
---
## CpioArchive() {#constructor}

의 새 인스턴스를 초기화합니다.[`CpioArchive`](../) 클래스.
...
의 새 인스턴스를 초기화합니다.[`CpioArchive`](../) 클래스 및 작성 항목 목록은 아카이브에서 추출할 수 있습니다.
...
| InvalidDataException | *sourceStream* 유효한 cpio 아카이브가 아닙니다. |

### 비고

이 생성자는 항목의 압축을 풀지 않습니다. 보다[`Open`](../../cpioentry/open/)포장 풀기 방법.
