...
description: 初始化WimArchiveaspose.zip.wim/wimarchive可以从存档中提取类和组成条目列表
type: docs
weight: 10
...
初始化[`WimArchive`](../../wimarchive)可以从存档中提取类和组成条目列表。
...
此构造函数不解压缩任何条目。看[`Open`](../../wimfileentry/open)解包方法.
