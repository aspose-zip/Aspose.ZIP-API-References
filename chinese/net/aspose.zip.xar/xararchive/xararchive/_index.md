...
description: 初始化XarArchiveaspose.zip.xar/xararchive类的新实例并组成条目列表可以从存档中提取
type: docs
weight: 10
...
初始化[`XarArchive`](../../xararchive)类的新实例并组成条目列表可以从存档中提取。
...
此构造函数不会解压缩任何条目。请参阅[`Open`](../../xarfileentry/open)方法进行解包。
