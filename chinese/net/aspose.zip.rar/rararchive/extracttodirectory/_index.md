...
| 例外 | （健康）状况 |
| --- | --- |
| ArgumentNullException | *destinationDirectory*为空。 |
...
| ArgumentException | *destinationDirectory*是零长度字符串，仅包含空格，或者包含一个或多个无效字符。您可以使用 System.IO.Path.GetInvalidPathChars 方法查询无效字符。 - 或 - 路径以或仅包含冒号字符 (:) 为前缀。 |
