...
description: Initialisiert eine neue Instanz vonXarArchiveaspose.zip.xar/xararchive Klasse und Liste der zusammengesetzten Einträge können aus dem Archiv extrahiert werden.
type: docs
weight: 10
...
Initialisiert eine neue Instanz von[`XarArchive`](../../xararchive) Klasse und Liste der zusammengesetzten Einträge können aus dem Archiv extrahiert werden.
