...
description: Initialisiert eine neue Instanz vonCabArchiveaspose.zip.cab/cabarchive Klasse und Liste der zusammengesetzten Einträge können aus dem Archiv extrahiert werden.
type: docs
weight: 10
...
Initialisiert eine neue Instanz von[`CabArchive`](../../cabarchive) Klasse und Liste der zusammengesetzten Einträge können aus dem Archiv extrahiert werden.
