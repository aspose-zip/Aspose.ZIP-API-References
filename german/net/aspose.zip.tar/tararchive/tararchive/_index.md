...
description: Initialisiert eine neue Instanz vonTarArchiveaspose.zip.tar/tararchive Klasse.
type: docs
weight: 10
...
Initialisiert eine neue Instanz von[`TarArchive`](../../tararchive) Klasse.
...
Initialisiert eine neue Instanz von[`TarArchive`](../../tararchive) Klasse und Liste der zusammengesetzten Einträge können aus dem Archiv extrahiert werden.
