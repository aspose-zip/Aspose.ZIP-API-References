...
description: Initialisiert eine neue Instanz vonWimArchiveaspose.zip.wim/wimarchive Klasse und Liste der zusammengesetzten Einträge können aus dem Archiv extrahiert werden.
type: docs
weight: 10
...
Initialisiert eine neue Instanz von[`WimArchive`](../../wimarchive) Klasse und Liste der zusammengesetzten Einträge können aus dem Archiv extrahiert werden.
