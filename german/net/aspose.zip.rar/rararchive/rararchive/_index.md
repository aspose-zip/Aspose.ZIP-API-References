...
description: Initialisiert eine neue Instanz vonRarArchiveaspose.zip.rar/rararchive Klasse und Liste der zusammengesetzten Einträge können aus dem Archiv extrahiert werden.
type: docs
weight: 10
...
Initialisiert eine neue Instanz von[`RarArchive`](../../rararchive) Klasse und Liste der zusammengesetzten Einträge können aus dem Archiv extrahiert werden.
