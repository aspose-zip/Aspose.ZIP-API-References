...
description: Initialisiert eine neue Instanz vonCpioArchiveaspose.zip.cpio/cpioarchive Klasse.
type: docs
weight: 10
...
Initialisiert eine neue Instanz von[`CpioArchive`](../../cpioarchive) Klasse.
...
Initialisiert eine neue Instanz von[`CpioArchive`](../../cpioarchive) Klasse und Liste der zusammengesetzten Einträge können aus dem Archiv extrahiert werden.
