...
description: Inicializa una nueva instancia delCabArchiveaspose.zip.cab/cabarchive La lista de entradas de clases y composiciones se puede extraer del archivo.
type: docs
weight: 10
...
Inicializa una nueva instancia del[`CabArchive`](../../cabarchive) La lista de entradas de clases y composiciones se puede extraer del archivo.
