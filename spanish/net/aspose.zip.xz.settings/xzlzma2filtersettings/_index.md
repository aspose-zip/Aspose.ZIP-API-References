...
description: Conjunto de ajustes para filtro xz LZMA2.
type: docs
weight: 760
...
| Nombre | Descripción |
| --- | --- |
| [XzLZMA2FilterSettings](xzlzma2filtersettings)(uint) | Inicializa una nueva instancia del[`XzLZMA2FilterSettings`](../xzlzma2filtersettings) . |
