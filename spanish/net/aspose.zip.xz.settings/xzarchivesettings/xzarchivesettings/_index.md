...
description: Inicializa una nueva instancia delXzArchiveSettingsaspose.zip.xz.settings/xzarchivesettings clase usando una sola compresión LZMA2.
type: docs
weight: 10
...
Inicializa una nueva instancia del[`XzArchiveSettings`](../../xzarchivesettings) clase usando una sola compresión LZMA2.
...
Inicializa una nueva instancia del[`XzArchiveSettings`](../../xzarchivesettings) clase con parámetros personalizados.
