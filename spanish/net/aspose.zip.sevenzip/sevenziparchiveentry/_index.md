...
description: Representa un solo archivo dentro del archivo 7z.
type: docs
weight: 560
...
Lanzar un[`SevenZipArchiveEntry`](../sevenziparchiveentry) instancia a[`SevenZipArchiveEntryEncrypted`](../sevenziparchiveentryencrypted) para determinar si la entrada está encriptada o no.
