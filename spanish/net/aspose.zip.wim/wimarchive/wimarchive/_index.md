...
description: Inicializa una nueva instancia delWimArchiveaspose.zip.wim/wimarchive La lista de entradas de clases y composiciones se puede extraer del archivo.
type: docs
weight: 10
...
Inicializa una nueva instancia del[`WimArchive`](../../wimarchive) La lista de entradas de clases y composiciones se puede extraer del archivo.
