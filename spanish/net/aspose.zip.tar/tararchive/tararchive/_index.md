...
description: Inicializa una nueva instancia delTarArchiveaspose.zip.tar/tararchive clase.
type: docs
weight: 10
...
Inicializa una nueva instancia del[`TarArchive`](../../tararchive) clase.
...
Inicializa una nueva instancia del[`TarArchive`](../../tararchive) La lista de entradas de clases y composiciones se puede extraer del archivo.
