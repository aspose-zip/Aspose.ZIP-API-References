...
description: Inicializa una nueva instancia delRarArchiveaspose.zip.rar/rararchive La lista de entradas de clases y composiciones se puede extraer del archivo.
type: docs
weight: 10
...
Inicializa una nueva instancia del[`RarArchive`](../../rararchive) La lista de entradas de clases y composiciones se puede extraer del archivo.
