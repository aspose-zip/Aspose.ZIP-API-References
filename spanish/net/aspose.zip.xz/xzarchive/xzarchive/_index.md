...
description: Inicializa una nueva instancia delXzArchiveaspose.zip.xz/xzarchive class y compone el archivo en formato xz.
type: docs
weight: 10
...
Inicializa una nueva instancia del[`XzArchive`](../../xzarchive) class y compone el archivo en formato xz.
...
Inicializa una nueva instancia del[`XzArchive`](../../xzarchive) clase preparada para descomprimir.
