...
description: Inicializa una nueva instancia delLzmaArchiveaspose.zip.lzma/lzmaarchive class y compone el archivo en formato lzma.
type: docs
weight: 10
...
Inicializa una nueva instancia del[`LzmaArchive`](../../lzmaarchive) class y compone el archivo en formato lzma.
...
Inicializa una nueva instancia del[`LzmaArchive`](../../lzmaarchive) clase preparada para descomprimir.
