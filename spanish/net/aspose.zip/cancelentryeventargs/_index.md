...
description: Argumentos de eventos para eventos relacionados con entradas cancelables.
type: docs
weight: 100
...
| Nombre | Descripción |
| --- | --- |
| [CancelEntryEventArgs](cancelentryeventargs)(ArchiveEntry) | Inicializa una nueva instancia del[`CancelEntryEventArgs`](../cancelentryeventargs) clase. |
