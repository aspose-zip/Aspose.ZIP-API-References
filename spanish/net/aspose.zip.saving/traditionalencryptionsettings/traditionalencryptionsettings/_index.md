...
description: Inicializa una nueva instancia delTraditionalEncryptionSettingsaspose.zip.saving/traditionalencryptionsettings clase.
type: docs
weight: 10
...
Inicializa una nueva instancia del[`TraditionalEncryptionSettings`](../../traditionalencryptionsettings) clase.
...
Inicializa una nueva instancia del[`TraditionalEncryptionSettings`](../../traditionalencryptionsettings) clase con codificación definida por el usuario.
...
Inicializa una nueva instancia del[`TraditionalEncryptionSettings`](../../traditionalencryptionsettings) clase sin contraseña.
