...
description: El tamaño del diccionario búfer de historial indica cuántos bytes de los datos sin comprimir recientemente procesados se mantienen en la memoria. Si no se establece se elegirá de acuerdo con el tamaño de la entrada.
type: docs
weight: 20
