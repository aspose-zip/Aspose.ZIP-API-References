...
description: Obtiene o establece la estimación de memoria en megabytes disponibles para acomodar las entradas comprimidas sin cambiar al disco. Este valor solo tiene sentido siParallelCompressInMemoryaspose.zip.saving/paralleloptions/parallelcompressinmemory el ajuste está enAuto modo.
type: docs
weight: 20
