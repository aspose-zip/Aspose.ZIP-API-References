...
description: Configuración del método de compresión LZMA.
type: docs
weight: 390
...
| Nombre | Descripción |
| --- | --- |
| [LzmaCompressionSettings](lzmacompressionsettings)() | Inicializa una nueva instancia del[`LzmaCompressionSettings`](../lzmacompressionsettings) clase con tamaño de diccionario predeterminado, igual a 16 megabytes. |
