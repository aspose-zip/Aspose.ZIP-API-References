...
description: Inicializa una nueva instancia delXarArchiveaspose.zip.xar/xararchive La lista de entradas de clases y composiciones se puede extraer del archivo.
type: docs
weight: 10
...
Inicializa una nueva instancia del[`XarArchive`](../../xararchive) La lista de entradas de clases y composiciones se puede extraer del archivo.
