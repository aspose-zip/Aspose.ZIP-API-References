...
description: Initialise une nouvelle instance duXarArchiveaspose.zip.xar/xararchive la liste des entrées de classe et de composition peut être extraite de larchive.
type: docs
weight: 10
...
Initialise une nouvelle instance du[`XarArchive`](../../xararchive) la liste des entrées de classe et de composition peut être extraite de l'archive.
