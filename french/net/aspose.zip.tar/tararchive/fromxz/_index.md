...
description: Extrait larchive au format xz fournie et composeTarArchiveaspose.zip.tar/tararchive à partir des données extraites.
type: docs
weight: 40
...
Extrait l'archive au format xz fournie et compose[`TarArchive`](../../tararchive) à partir des données extraites.
