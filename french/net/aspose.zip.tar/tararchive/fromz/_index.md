...
description: Extrait larchive au format Z fournie et composeTarArchiveaspose.zip.tar/tararchive à partir des données extraites.
type: docs
weight: 50
...
Extrait l'archive au format Z fournie et compose[`TarArchive`](../../tararchive) à partir des données extraites.
