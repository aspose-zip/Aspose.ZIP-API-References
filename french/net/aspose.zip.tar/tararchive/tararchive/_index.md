...
description: Initialise une nouvelle instance duTarArchiveaspose.zip.tar/tararchive classe.
type: docs
weight: 10
...
Initialise une nouvelle instance du[`TarArchive`](../../tararchive) classe.
...
Initialise une nouvelle instance du[`TarArchive`](../../tararchive) la liste des entrées de classe et de composition peut être extraite de l'archive.
