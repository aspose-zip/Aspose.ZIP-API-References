...
description: Initialise une nouvelle instance duSnappyArchiveaspose.zip.snappy/snappyarchive classe préparée pour la compression.
type: docs
weight: 10
...
Initialise une nouvelle instance du[`SnappyArchive`](../../snappyarchive) classe préparée pour la compression.
...
Initialise une nouvelle instance du[`SnappyArchive`](../../snappyarchive) classe préparée pour la décompression.
