...
description: Initialise une nouvelle instance duCpioArchiveaspose.zip.cpio/cpioarchive classe.
type: docs
weight: 10
...
Initialise une nouvelle instance du[`CpioArchive`](../../cpioarchive) classe.
...
Initialise une nouvelle instance du[`CpioArchive`](../../cpioarchive) la liste des entrées de classe et de composition peut être extraite de l'archive.
