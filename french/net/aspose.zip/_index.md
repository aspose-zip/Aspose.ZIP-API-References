...
description: LeZip lespace de noms contient des classes qui représentent des entités liées aux archives.
type: docs
weight: 10
url: /fr/net/aspose.zip/
---
LeZip l'espace de noms contient des classes qui représentent des entités liées aux archives.
