...
description: Représente un répertoire unique dans larchive wim.
type: docs
weight: 640
...
| [Directories](../../aspose.zip.wim/wimdirectoryentry/directories) { get; } | Obtient les entrées de[`WimDirectoryEntry`](../wimdirectoryentry) type constituant le répertoire. |
