...
description: Cette classe représente le fichier darchive 7z. Utilisezle pour composer et extraire des archives 7z.
type: docs
weight: 550
...
| Nom | La description |
| --- | --- |
| [SevenZipArchive](sevenziparchive#constructor)(SevenZipEntrySettings) | Initialise une nouvelle instance du[`SevenZipArchive`](../sevenziparchive)classe avec des paramètres facultatifs pour ses entrées. |
| [SevenZipArchive](sevenziparchive#constructor_1)(Stream) | Initialise une nouvelle instance du[`SevenZipArchive`](../sevenziparchive) la liste des entrées de classe et de composition peut être extraite de l'archive. |
| [SevenZipArchive](sevenziparchive#constructor_2)(string) | Initialise une nouvelle instance du[`SevenZipArchive`](../sevenziparchive) la liste des entrées de classe et de composition peut être extraite de l'archive. |
