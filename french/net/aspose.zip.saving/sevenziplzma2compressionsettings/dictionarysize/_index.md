...
description: La taille du dictionnaire tampon dhistorique indique combien doctets des données non compressées récemment traitées sont conservés en mémoire.
type: docs
weight: 20
