...
description: Obtient ou définit lestimation de la mémoire en mégaoctets disponibles pour accueillir les entrées compressées sans permuter sur le disque. Cette valeur na de sens que siParallelCompressInMemoryaspose.zip.saving/paralleloptions/parallelcompressinmemory le réglage est enAuto mode.
type: docs
weight: 20
