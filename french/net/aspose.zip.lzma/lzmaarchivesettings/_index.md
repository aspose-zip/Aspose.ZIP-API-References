...
description: Paramètres pour la méthode de compression LZMA dans larchive lzma.
type: docs
weight: 180
...
| Nom | La description |
| --- | --- |
| [LzmaArchiveSettings](lzmaarchivesettings)() | Initialise une nouvelle instance du[`LzmaArchiveSettings`](../lzmaarchivesettings) classe avec une taille de dictionnaire par défaut, égale à 16 mégaoctets. |
