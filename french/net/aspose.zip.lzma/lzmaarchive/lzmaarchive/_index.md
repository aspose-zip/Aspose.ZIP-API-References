...
description: Initialise une nouvelle instance duLzmaArchiveaspose.zip.lzma/lzmaarchive classe et compose larchive au format lzma.
type: docs
weight: 10
...
Initialise une nouvelle instance du[`LzmaArchive`](../../lzmaarchive) classe et compose l'archive au format lzma.
...
Initialise une nouvelle instance du[`LzmaArchive`](../../lzmaarchive) classe préparée pour la décompression.
