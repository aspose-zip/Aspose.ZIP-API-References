...
| اسم | وصف |
| --- | --- |
| [AesEcryptionSettings](aesecryptionsettings#constructor)(EncryptionMethod) | يقوم بتهيئة مثيل جديد لملف[`AesEcryptionSettings`](../aesecryptionsettings) فئة بدون كلمة مرور. |
| [AesEcryptionSettings](aesecryptionsettings#constructor_1)(string, EncryptionMethod) | يقوم بتهيئة مثيل جديد لملف[`AesEcryptionSettings`](../aesecryptionsettings) فئة . |
