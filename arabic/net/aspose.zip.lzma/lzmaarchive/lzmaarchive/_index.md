...
description: يقوم بتهيئة مثيل جديد لملفLzmaArchiveaspose.zip.lzma/lzmaarchive فئة ويؤلف الأرشيف بتنسيق lzma.
type: docs
weight: 10
...
يقوم بتهيئة مثيل جديد لملف[`LzmaArchive`](../../lzmaarchive) فئة ويؤلف الأرشيف بتنسيق lzma.
...
يقوم بتهيئة مثيل جديد لملف[`LzmaArchive`](../../lzmaarchive) فئة جاهزة لفك الضغط.
