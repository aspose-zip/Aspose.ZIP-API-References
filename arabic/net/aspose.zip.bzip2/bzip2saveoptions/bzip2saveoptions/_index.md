...
description: يقوم بتهيئة مثيل جديد لملفBzip2SaveOptionsaspose.zip.bzip2/bzip2saveoptions فئة .
type: docs
weight: 10
...
يقوم بتهيئة مثيل جديد لملف[`Bzip2SaveOptions`](../../bzip2saveoptions) فئة .
...
يقوم بتهيئة مثيل جديد لملف[`Bzip2SaveOptions`](../../bzip2saveoptions)فئة بحجم الكتلة الافتراضي ، تساوي 9 مائة كيلو بايت.
