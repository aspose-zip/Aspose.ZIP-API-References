...
description: يقوم بتهيئة مثيل جديد لملفBzip2Archiveaspose.zip.bzip2/bzip2archive فئة جاهزة للضغط.
type: docs
weight: 10
...
يقوم بتهيئة مثيل جديد لملف[`Bzip2Archive`](../../bzip2archive) فئة جاهزة للضغط.
...
يقوم بتهيئة مثيل جديد لملف[`Bzip2Archive`](../../bzip2archive) فئة جاهزة لفك الضغط.
