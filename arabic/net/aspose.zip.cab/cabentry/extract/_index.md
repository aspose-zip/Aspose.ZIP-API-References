...
description: CabEntry طريقة. لاستخراج الإدخال إلى نظام الملفات من خلال المسار المتوفر.
type: docs
weight: 30
url: /ar/net/aspose.zip.cab/cabentry/extract/
---
...
استخراج إدخال من أرشيف الكابينة.
