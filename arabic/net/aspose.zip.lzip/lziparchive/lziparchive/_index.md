...
description: يقوم بتهيئة مثيل جديد لملفLzipArchiveaspose.zip.lzip/lziparchive .
type: docs
weight: 10
...
يقوم بتهيئة مثيل جديد لملف[`LzipArchive`](../../lziparchive) .
...
يقوم بتهيئة مثيل جديد لملف[`LzipArchive`](../../lziparchive) فئة جاهزة لفك الضغط.
