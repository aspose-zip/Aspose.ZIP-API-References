...
description: يقوم بتهيئة مثيل جديد لملفXzArchiveaspose.zip.xz/xzarchive class ويؤلف الأرشيف بتنسيق xz.
type: docs
weight: 10
...
يقوم بتهيئة مثيل جديد لملف[`XzArchive`](../../xzarchive) class ويؤلف الأرشيف بتنسيق xz.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| settings | XzArchiveSettings | مجموعة من الإعدادات الخاصة بأرشيف xz: حجم القاموس ، وحجم الكتلة ، ونوع التحقق. |
...
يقوم بتهيئة مثيل جديد لملف[`XzArchive`](../../xzarchive) فئة جاهزة لفك الضغط.
...
هذا المُنشئ لا يقوم بفك ضغط. نرى[`Extract`](../extract) طريقة فك الضغط.
