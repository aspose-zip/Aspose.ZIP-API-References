...
description: يقوم بتهيئة مثيل جديد لملفZArchiveaspose.zip.z/zarchive فئة جاهزة للضغط.
type: docs
weight: 10
...
يقوم بتهيئة مثيل جديد لملف[`ZArchive`](../../zarchive) فئة جاهزة للضغط.
...
يقوم بتهيئة مثيل جديد لملف[`ZArchive`](../../zarchive) فئة جاهزة لفك الضغط.
