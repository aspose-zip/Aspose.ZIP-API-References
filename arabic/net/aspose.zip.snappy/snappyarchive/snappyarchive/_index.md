...
description: يقوم بتهيئة مثيل جديد لملفSnappyArchiveaspose.zip.snappy/snappyarchive فئة جاهزة للضغط.
type: docs
weight: 10
...
يقوم بتهيئة مثيل جديد لملف[`SnappyArchive`](../../snappyarchive) فئة جاهزة للضغط.
...
يقوم بتهيئة مثيل جديد لملف[`SnappyArchive`](../../snappyarchive) فئة جاهزة لفك الضغط.
