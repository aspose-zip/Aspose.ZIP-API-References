...
description: يقوم بتهيئة مثيل جديد لملفTarArchiveaspose.zip.tar/tararchive فئة .
type: docs
weight: 10
...
يقوم بتهيئة مثيل جديد لملف[`TarArchive`](../../tararchive) فئة .
...
لا يقوم المُنشئ هذا بفك ضغط أي إدخال. نرى[`Open`](../../tarentry/open) طريقة التفريغ .
...
يقوم بتهيئة مثيل جديد لملف[`TarArchive`](../../tararchive) يمكن استخراج فئة ويؤلف قائمة إدخالات من الأرشيف.
