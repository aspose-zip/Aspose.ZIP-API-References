...
description: هذه الفئة تمثل ملف أرشيف tar. استخدمه لإنشاء أو استخراج أو تحديث أرشيفات tar.
type: docs
weight: 600
...
| اسم | وصف |
| --- | --- |
| [TarArchive](tararchive#constructor)() | يقوم بتهيئة مثيل جديد لملف[`TarArchive`](../tararchive) فئة . |
...
| [TarArchive](tararchive#constructor_2)(string) | يقوم بتهيئة مثيل جديد لملف[`TarArchive`](../tararchive) يمكن استخراج فئة ويؤلف قائمة إدخالات من الأرشيف. |

## الخصائص

| اسم | وصف |
| --- | --- |
| [Entries](../../aspose.zip.tar/tararchive/entries) { get; } | يحصل على إدخالات[`TarEntry`](../tarentry) النوع المكون للأرشيف. |

## طُرق

| اسم | وصف |
| --- | --- |
| static [FromGZip](../../aspose.zip.tar/tararchive/fromgzip#fromgzip)(Stream) | مقتطفات من أرشيف gzip وتكوينه[`TarArchive`](../tararchive) من البيانات المستخرجة. |
| static [FromGZip](../../aspose.zip.tar/tararchive/fromgzip#fromgzip_1)(string) | مقتطفات من أرشيف gzip وتكوينه[`TarArchive`](../tararchive) من البيانات المستخرجة. |
| static [FromLZip](../../aspose.zip.tar/tararchive/fromlzip#fromlzip)(Stream) | المقتطفات المقدمة أرشيف lzip ويؤلف[`TarArchive`](../tararchive) من البيانات المستخرجة. |
| static [FromLZip](../../aspose.zip.tar/tararchive/fromlzip#fromlzip_1)(string) | المقتطفات المقدمة أرشيف lzip ويؤلف[`TarArchive`](../tararchive) من البيانات المستخرجة. |
| static [FromXz](../../aspose.zip.tar/tararchive/fromxz#fromxz)(Stream) | يتم توفير مقتطفات من أرشيف بتنسيق xz ويؤلف[`TarArchive`](../tararchive) من البيانات المستخرجة. |
| static [FromXz](../../aspose.zip.tar/tararchive/fromxz#fromxz_1)(string) | يتم توفير مقتطفات من أرشيف بتنسيق xz ويؤلف[`TarArchive`](../tararchive) من البيانات المستخرجة. |
| static [FromZ](../../aspose.zip.tar/tararchive/fromz#fromz)(Stream) | يتم توفير مقتطفات من أرشيف بتنسيق Z ويؤلف[`TarArchive`](../tararchive) من البيانات المستخرجة. |
| static [FromZ](../../aspose.zip.tar/tararchive/fromz#fromz_1)(string) | يتم توفير مقتطفات من أرشيف بتنسيق Z ويؤلف[`TarArchive`](../tararchive) من البيانات المستخرجة. |
...
| [DeleteEntry](../../aspose.zip.tar/tararchive/deleteentry#deleteentry)(TarEntry) | يزيل التواجد الأول لإدخال محدد من قائمة الإدخالات. |
...
| [SaveGzipped](../../aspose.zip.tar/tararchive/savegzipped#savegzipped)(Stream, TarFormat?) | لحفظ الأرشيف في التدفق بضغط gzip . |
