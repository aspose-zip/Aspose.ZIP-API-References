...
description: ملفRar يحتوي مساحة الاسم على الفئات التي تمثل الكيانات ذات الصلة بأرشيف RAR.
type: docs
weight: 80
url: /ar/net/aspose.zip.rar/
---
ملفRar يحتوي مساحة الاسم على الفئات التي تمثل الكيانات ذات الصلة بأرشيف RAR.
